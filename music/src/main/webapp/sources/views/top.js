	...
	config(){
		...
		var menu = {
			...
			data:[
				...
				{ value:"Music Groups", id:"groups", icon:"wxi-pencil" },
				{ value:"Albums", id:"allalbumsview", icon:"wxi-pencil" },
				{ value:"Search", id:"groupsearchview", icon:"wxi-search" }
			]
		};
		...
		var ui = {
			...
			cols:[
				...
				{ type:"wide", paddingY:10, paddingX:5,
					rows:[
						{ $subview:true }
					]
				}
